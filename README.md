...
・メリット<br>
  ...
  SNS：ユーザーが気軽に投稿できることや飲食店検索アプリなどには掲載されていない様な情報も投稿し易い。
...
<dl>
  ...
  <dt>ユーザー編集画面</dt>
    ...
    <dd>店舗ユーザー：店舗名、メールアドレス、郵便番号、都道府県、市町区村、番地、建物名（任意）、電話番号、ホームページリンク（任意）、プロフィール（任意）の入力、選択欄が表示されている。各項目を再入力後、保存ボタンを押すとユーザー情報が変更される。</dd>
</dl>
